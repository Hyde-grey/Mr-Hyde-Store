...
Command: npx gltfjsx@6.5.3 public/SpaceManModel/SpaceManModelandCross/SpaceManModel.gltf --types 
*/
//@ts-nocheck
...
export function SpaceManModelandCross(props: JSX.IntrinsicElements["group"]) {
  const groupRef = useRef<THREE.Group>(null);
  const scroll = useScroll();
  const radius = 50; // Radius of the circular path
  const { nodes, materials } = useGLTF(
    "/SpaceManModel/SpaceManModelandCross/SpaceManModel.gltf"
  ) as GLTFResult;
...
useGLTF.preload("/SpaceManModel/SpaceManModelandCross/SpaceManModel.gltf");
